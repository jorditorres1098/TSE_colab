...
\gabriele{There is a differnece with how this is addressed in the book, even 
though the procedure is the same. Here we are looking at an estimator for the first derivative of the density, while in the book we are estimating the pdf}
...
\gabriele{A holder class is defined as a function of two parameters, $\beta$ and $L$. $l$ is simply the floor of $\beta$, ie the largest strictly smallest integer.}

\gabriele{Whether a function satisfies a Holder conditions has implications for its smoothness. If it satisfies it, it is bounded and smooth.}
